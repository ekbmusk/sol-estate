...
export const mockProjects: Project[] = [
  {
    ...
    description:
      "Солнечная электростанция мощностью 25 кВт на кампусе университета. Ежегодная выработка — 42.65 МВт·ч. Предотвращение выбросов — 36 тонн CO₂/год (коэффициент 0.636 кг CO₂/кВт·ч для угольной генерации КЗ). Realtime мониторинг через SOLARMAN API. Расположена в Туркестанской области — регионе с наибольшей инсоляцией в Казахстане (1,700+ кВт·ч/м²/год). Рядом реализуется СЭС M-KAT мощностью 100 МВт (Masdar, ОАЭ).",
    projectType: "solar",
    totalCredits: 36,
    creditsRetired: 0,
    totalShares: 360,
